...
const Contact = () => {
  ...
  // const route = () => {
  //   router.push(url, 'facebook.com/sandwicheswithlove')
  // }
  return (
    <>
          ...
          <div className="flex flex-wrap">
            <div className="w-full lg:w-6/12 px-4">
              ...
              <div className="mt-6">
                ...
                <button
                  className="bg-red-500 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-2"
                  type="button"
